...
const Comment = ({ comment, userId, username }) => {
  const [showModal, setShowModal] = useState(false); // Ajoutez un état pour contrôler l'affichage de la modal de suppression
  ...
  return (
    <div className="bg-gray-100 p-2 rounded-lg shadow-md mb-2">
      <div className="flex items-center mb-2">
        {/* Utilisez un lien pour rediriger vers la page de profil */}
      ...
      {/* Modal pour confirmer la suppression du commentaire */}
      {showModal && (
