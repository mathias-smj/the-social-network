...
import { getCommentsForTweet } from '../../api/models/comments.js';
...
const Tweet = ({ tweetId, userId, avatar_url, username, createdAt, content, onDelete }) => {
  ...
  const handleDeleteTweetLocally = () => {
    setComments((prevComments) => prevComments.filter((comment) => comment.id !== tweetId));
  };
  ...
  return (
    <>
      <div className="container mx-auto pb-8">
        ...
        {showCommentForm && <CommentTweetList tweetId={tweetId} />}
      </div>
    </>
